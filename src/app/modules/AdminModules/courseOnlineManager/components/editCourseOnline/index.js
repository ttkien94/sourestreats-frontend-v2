...
function EditCourseOnline({ onToggleDrawer, courseOnline }) {
  ...
  const initialValues = {
    ...
    gender: courseOnline?.gender,
    email: courseOnline?.email,
    phone: courseOnline?.phone,
    address: courseOnline?.address || "",
    birthDay: courseOnline?.birthDay,
    role: courseOnline?.role,
    password: "",
  };
