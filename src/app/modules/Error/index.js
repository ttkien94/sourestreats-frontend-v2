  ...
  return (
    <div className="notFound">
      <div className="wrapperNotFound">
        <svg className="monkeyPic" viewBox="0 0 800 480">
          <path
            className="st0"
...
C163.3,304.6,165,300.3,165,296z"
                />
                <path className="st1" d="M146.6,295.1c0,0,10.8-1.4,16.7,9.6" />
                <path className="st1" d="M144.4,296c0,0,8.7-6.6,19.2,0" />
              </g>
            </g>
          </g>
          <g className="tetris_path">
            <g className="tetris">
              <path
                id="tetris_stroke"
                className="st1"
