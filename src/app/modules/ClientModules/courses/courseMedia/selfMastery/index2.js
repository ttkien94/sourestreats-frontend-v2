...
function SelfMastery() {
  ...
  const vimeo = document.querySelectorAll("iframe");
  useEffect(() => {
    // question === true && console.log("true");
      ...
      {(userInfo.role === "sm" ||
        ...
        <section className="co-detail-video">
          ...
          */}
            ...
            <Vimeo
              video="https://player.vimeo.com/video/876600835?badge=0&amp;autopause=0&amp;quality_selector=1&amp;progress_bar=1&amp;player_id=0&amp;app_id=58479"
              allow="autoplay; fullscreen; picture-in-picture"
              title="Mối quan hệ hoàn hảo"
              frameborder="0"
              paused={paused}
