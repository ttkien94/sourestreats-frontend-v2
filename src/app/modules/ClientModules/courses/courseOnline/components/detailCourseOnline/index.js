...
function DetailCourseOnline(props) {
  return (
    <div className="detail-course-online mt-4 col-md-12">
      <TitleCourse title="detail_course" />
      <div className=" detail-course-online-content mt-2">
        <div className="row">
...
export default DetailCourseOnline;
